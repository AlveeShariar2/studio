    ...
    <div className="py-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <InfoItem label="Battery" value="95%" icon={<BatteryFull className="h-5 w-5 text-primary" />} />
            <InfoItem label="GPS Status" value="On" icon={<MapPin className="h-5 w-5 text-primary" />} />
            <InfoItem label="Wi-Fi" value="Home_Network_5G" icon={<Wifi className="h-5 w-5 text-primary" />} />
            <InfoItem label="Device Status" value="Online" icon={<Smartphone className="h-5 w-5 text-primary" />} />
        </CardContent>
      </Card>
