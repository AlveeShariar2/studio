...
const initialKeywords = ["casino", "violence", "hate speech"]
    ...
    <div className="py-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage profiles, content filters, and other settings.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Block websites and content containing specific keywords.
                </p>
                <div className="space-y-2">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="space-y-4">
                <div className="flex items-center justify-between rounded-lg border p-4">
                  <div>
                    <Label htmlFor="stealth-mode" className="font-semibold">
                      Stealth Mode
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Hide the SurokkhaNet app icon on the device.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-lg border p-4">
                  <div>
                    <Label htmlFor="remote-control" className="font-semibold">
                      Remote Control
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Enable remote commands like screenshots and data export.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-lg border p-4">
                  <div>
                    <Label htmlFor="call-recording" className="font-semibold">
                      Call Recording
                    </Label>
                    <p className="text-xs text-muted-foreground">
